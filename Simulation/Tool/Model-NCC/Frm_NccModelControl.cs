...
namespace Vision.Tool.Model
{
    public partial class Frm_NccModelControl : Form
    {
        ...
        private void Frm_NccModelControl_Load(object sender, EventArgs e)
        {
            ...
            SafeSetUpDownRange(StartingAngleUpDown, DegFromRad(nCCModel.nCCParam.AngleStart));
            SafeSetUpDownRange(AngleExtentUpDown, DegFromRad(nCCModel.nCCParam.AngleExtent));
            ...
            SafeSetUpDownRange(numericUpDown1, nCCModel.nCCParam.MaxOverlap * 100);
        ...
        private void UpDown_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                case "1":
                    nCCModel.nCCParam.AngleStart = (float)DegToRad((double)StartingAngleUpDown.Value);
                    nCCModel.createNewModelID = true;
                    break;
                case "2":
                    nCCModel.nCCParam.AngleExtent = (float)DegToRad((double)AngleExtentUpDown.Value);
                    nCCModel.createNewModelID = true;
                    break;
                case "3":
                ...
                case "6":
                    ...
                    break;
                case "7":
                    nCCModel.nCCParam.MaxOverlap = (float)numericUpDown1.Value / 100.0f;
                    break;
                case "8":
