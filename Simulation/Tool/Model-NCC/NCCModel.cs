    ...
    public class NCCModel
    {
        ...
        public void FindNccModel()
        {
            ...
            try
            {
                ...
                HOperatorSet.FindNccModel(cropImg, nCCModel, nCCParam.AngleStart, nCCParam.AngleExtent, nCCParam.MinScore,
                    nCCParam.NumMatches, nCCParam.MaxOverlap, nCCParam.SubPixel, 0, out OutputResult.Row, out OutputResult.Col, out OutputResult.Angle, out OutputResult.Score);
