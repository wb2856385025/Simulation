...
namespace Vision.Tool.Model
{
    public partial class Frm_ShapeModelControl : Form
    {
        ...
        private void Frm_ShapeModelControl_Load(object sender, EventArgs e)
        {
            ...
            panel4.Size = new Size(453, 120);
            label24.Text = "高级设置︾";
            panel5.Size = new Size(453, 205);
            label18.Text = "高级设置︾";
            ...
            toolStripComboBox1.Items.Add("矩形");
            toolStripComboBox1.Items.Add("圆");
            toolStripComboBox1.Items.Add("矩形2");
        ...
        private void DisplayMatchResult()
        {
            ...
            //    hHomMat2D.VectorAngleToRigid(0, 0, 0, Model.OutputResult.Row[i].D, Model.OutputResult.Col[i].D, Model.OutputResult.Angle[i].D);
            ...
            //    hHomMat2D = hHomMat2D.HomMat2dTranslateLocal(-row, -col);
        ...
        {
            //this.Text = Model.InputImg.Key.ToString();
        }
        ...
        {
            if (panel4.Size.Height == 120)
            {
                panel4.Size = new Size(453, 311);
                label24.Text = "高级设置︽";
            }
            else
            {
        ...
        {
            if (panel5.Size.Height == 205)
            {
                panel5.Size = new Size(453, 400);
                label18.Text = "高级设置︽";
            }
            else
            {
